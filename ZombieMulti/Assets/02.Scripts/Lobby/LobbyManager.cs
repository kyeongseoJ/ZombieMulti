...
using Photon.Realtime; // 포톤 관련 서비스 라이브러리
using UnityEngine;
using UnityEngine.UI; 
using TMPro; // Text Mesh Pro 사용 시 불러오기 

// 마스터(매치메이킹) 서버와 룸 접속 담당
public class LobbyManager : MonoBehaviourPunCallbacks{
    private string gameVersion = "1"; // 게임버전
    public TextMeshProUGUI connectionInfoText; // 네트워크 정보 갱신 텍스트
    public Button joinButton; // 룸 접속 버튼

    // 게임 시작과 동시에 마스터 서버 접속 시도 : 중요: 결과와 상관없이 그냥 시도하는 것이다.
    private void Start() {
        // 접속에 필요한 정보(게임버전) 설정
